...
public class AddSafari extends JFrame{
   ...
   mousewatch mw=new mousewatch();
    ...
    setLayout(new BorderLayout());
        setContentPane(new JLabel(new ImageIcon("C:\\Users\\moham\\OneDrive\\Documents\\NetBeansProjects\\Hotel-code\\Hotel Picture\\asia_beaches-wallpaper-1280x800 (Custom).jpg")));
    ...
    jlet.setBounds(jlsd.getX(), jlst.getY()+75, jlsd.getWidth(), jlsd.getHeight());
    jtet.setBounds(jlet.getX()+75, jlet.getY(),jlsd.getWidth(), jlsd.getHeight());
    jlprice.setBounds(jlet.getX(), jlet.getY()+75,jlsd.getWidth(), jlsd.getHeight());
    ...
    jlsd.setForeground(Color.black);
    jlst.setForeground(Color.BLACK);
    jlet.setForeground(Color.BLACK);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if(M1.add_safari(SD,ST,ET, price,num)==true){
                    JOptionPane.showMessageDialog(null, "Safari Trip added");
                }
                else
